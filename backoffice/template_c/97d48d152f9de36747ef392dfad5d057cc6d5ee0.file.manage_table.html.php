...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '918754c8f960514054-88705679',
  'function' => 
  array (
  ),
	...
	<div id="wrapper">
		...
		<div class="sidebar" aria-expanded="true">
            ...
            <?php if ($_smarty_tpl->tpl_vars['emp_privileges']->value['manage_standard_tables']) {?>
                <div class="tree-view">
			        <div class="tree-view-root">
                        <a>
                            <span class="root-label">ข้อมูลพื้นฐาน(<span class="allTreeViewChild"></span>)</span>
			        ...
			        <div class="tree-view-child">
				        <ul>
                            ...
                            <li id="tn-withdraw_types">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-order_types"></span>
                                    <span class="item-label">ประเภทการเบิก</span>
                                </a>
                            </li>
            ...
            <?php }?>
		        <div class="tree-view">
			        <div class="tree-view-root">
                        <a>
                            <span class="root-label">ข้อมูลหลัก(<span class="allTreeViewChild"></span>)</span>
                            <span class="root-icon"></span>
                        </a>
			        </div>
			        <div class="tree-view-child">
				        <ul>
                            ...
                            <li id="tn-shops">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-spa"></span>
                                    <span class="item-label">ร้านค้า</span>
                                </a>
                            </li>
					        <li id="tn-employees">
                                <a class="tree-view-item">
                            ...
                            <li id="tn-service_list_promotions">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-service_lists"></span>
                                    <span class="item-label">โปรโมชั่นรายการบริการ</span>
                                </a>
                            </li>
                            <li id="tn-service_list_promotion_details">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-service_lists"></span>
					        ...
					        <li id="tn-package_promotions">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-promotions"></span>
                                    <span class="item-label">โปรโมชั่นแพ็คเกจ</span>
                                </a>
					        </li>
                            <li id="tn-package_promotion_details">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-promotions"></span>
                                    <span class="item-label">แพ็คเกจที่จัดโปรโมชั่น</span>
                                </a>
                            </li>
                            ...
                            <li id="tn-product_promotion_groups">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-products"></span>
                                    <span class="item-label">กลุ่มโปรโมชั่นผลิตภัณฑ์</span>
                                </a>
                            </li>
                            <li id="tn-promotion_discout_sales">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-products"></span>
                                    <span class="item-label">โปรโมชั่นการขาย</span>
                                </a>
                            </li>
                            <li id="tn-product_promotions">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-products"></span>
                                    <span class="item-label">โปรโมชั่นผลิตภัณฑ์</span>
                                </a>
                            </li>
                            <li id="tn-promotion_products">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-products"></span>
                                    <span class="item-label">ผลิตภัณฑ์ที่จัดโปรโมชั่น</span>
                                </a>
                            </li>
                            <li id="tn-advertising">
                                <a class="tree-view-item">
                                    <span class="item-icon mbk-icon icon-products"></span>
                                    <span class="item-label">ประชาสัมพันธ์หน้าการเข้า-ออกงาน</span>
                                </a>
                            </li>
				        </ul>
			        </div>
			     ...
			     <div class="tree-view">
			        <div class="tree-view-root">
                        <a>
                            <span class="root-label">ข้อมูลอื่นๆ(<span class="allTreeViewChild"></span>)</span>
                            <span class="root-icon"></span>
                        </a>
			        </div>
			        <div class="tree-view-child">
		...
		<div class="no-select-table">
		  <div class="no-select-table-inner">
			<i class="fa fa-list-alt"></i><br>เลือกตารางเพื่อจัดการข้อมูล
		  </div>
		</div>
